...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Numbers
        let ap1 = Appearance(title : "0", color: UIColor.redColor())
        let ap2 = Appearance(title : "1", color: UIColor.redColor())
        let ap3 = Appearance(title : "2", color: UIColor.yellowColor())
        let ap4 = Appearance(title : "3", color: UIColor.blueColor())
        let ap5 = Appearance(title : "4", color: UIColor.orangeColor())
        let ap6 = Appearance(title : "5", color: UIColor.cyanColor())
        let ap7 = Appearance(title : "6", color: UIColor.brownColor())
        let ap8 = Appearance(title : "7", color: UIColor.darkGrayColor())
        ...
        let app1 = Appearance(imageNamed: "tool_1", color: UIColor.blueColor())
        let app2 = Appearance(imageNamed: "tool_2", color: UIColor.redColor())
        let app3 = Appearance(imageNamed: "tool_3", color: UIColor.magentaColor())
        let app4 = Appearance(imageNamed: "tool_4", color: UIColor.blueColor())
        let app5 = Appearance(imageNamed: "tool_5", color: UIColor.orangeColor())
